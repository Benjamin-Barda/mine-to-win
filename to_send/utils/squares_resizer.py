# Literally a JSONParser with ratios, we had to change the sizes
...
height_ratio = ne_height / or_height
width_ratio = ne_width / or_width
    ...
    for image_name , d in dic.items() :
        ...
        for mob, boxes in d.items() : 
            ...
            for box in boxes : 
                ...
                parsed[image_name][mob].append([mid_x * width_ratio, mid_y * height_ratio, W * width_ratio, H * height_ratio])
            
                
    with open(directory + 'rePARSED' + json_name, 'w') as g:
