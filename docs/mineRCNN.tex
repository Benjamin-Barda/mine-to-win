...
\begin{abstract}
    Real time object detection has recently been made possible due to steady state-of-the-art advancements  \cite{arxiv:FastRCNN, arxiv:FasterRCNN}
\end{abstract}
...
\begin{IEEEkeywords}
Minecraft, Object Detection, Convolutional Neural Network, Region Proposal, Real Time Detection
\end{IEEEkeywords}}
